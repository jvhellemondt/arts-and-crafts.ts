...
import { isRejection } from "../../../../../shared/utils/isRejection.ts";
...
> {
  ...
  private readonly outbox: StageIntents<NotifyUserToVerifyEmailV1, Promise<void | GatewayFailure>>;

  constructor(
    repository: OpenMembershipRepository,
