...
export class IntentRelay<TIntent extends Intent>
implements RelayPendingIntents, RegisterIntentSubscriber<TIntent> {
  private readonly handlers = new Map<string, HandleIntent<TIntent>>();
  ...
  subscribe<T extends TIntent>(intentType: T["type"], handler: HandleIntent<T>): void {
    this.handlers.set(intentType, handler as HandleIntent<TIntent>);
  }
