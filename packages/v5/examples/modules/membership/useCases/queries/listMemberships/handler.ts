...
export class ListMembershipsHandler
  implements HandleQuery<ListMembershipsQuery, Promise<MembershipSummary[] | GatewayFailure>>
{
  constructor(private readonly store: LoadProjection<ListMembershipsProjection>) {}

  async handle(_query: ListMembershipsQuery): Promise<MembershipSummary[] | GatewayFailure> {
